...
class CartManager3(models.Manager):
    def get_queryset(self):
        return super(CartManager3, self).get_queryset().all()
...
class Cart(models.Model):
    ...
    object3 = CartManager3()
    @classmethod
    def createcart(cls,user,product,productnum,productprice,isChose,order,isDelete):
        c = cls(user = user,product = product,productnum=productnum,productprice=productprice,isChose=isChose,order=order,isDelete=isDelete)
        return c
...
class Order(models.Model):
    ...
    @classmethod
    def createorder(cls, orderid, user, progress, isActive, isDelete):
        o = cls(orderid=orderid, user=user, progress=progress, isActive=isActive, isDelete=isDelete)
        return o